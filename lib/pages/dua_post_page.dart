...
class DuaPostPage extends StatelessWidget {
  final Dua dua;

  const DuaPostPage({super.key, required this.dua});
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (dua.uploaded != null)
                    Row(
                      children: [
                        ...
                        Text(
                          DateFormat('dd MMM yyyy').format(dua.uploaded!),
                          style: TextStyle(
                            color: Theme.of(context).colorScheme.onSurface.withOpacity(0.6),
                            fontSize: 13,
                          ),
                  ...
                  // Content (Dua text) - Instagram-like caption
                  Text(
                    dua.content,
                  ...
                  if (dua.link != null && 
                      dua.link!.isNotEmpty && 
                      (dua.link!.startsWith('http://') || dua.link!.startsWith('https://')))
                    SizedBox(
  ...
  Widget _buildImage(BuildContext context) {
    if (dua.image == null || dua.image!.isEmpty) {
      return Container(
        width: double.infinity,
    ...
    if (dua.image!.startsWith('http://') || dua.image!.startsWith('https://')) {
      return SizedBox(
        width: double.infinity,
        height: MediaQuery.of(context).size.height * 0.5,
        child: Image.network(
    ...
    // Asset image
    if (dua.image!.startsWith('assets/')) {
      return SizedBox(
        width: double.infinity,
        height: MediaQuery.of(context).size.height * 0.5,
        child: Image.asset(
